...
Тесты и проверка тестами выполняется с помощью pytest.
...
Главное, что надо знать про тесты к заданиям - это ни в коем случае не образец
написания тестов. Особенно тесты для 4-7 разделов. Там мне приходилось писать
дикие извращения чтобы протестировать базовый код, никак не нагружая учащихся.
Как только пошли функции (9 раздел), там тесты уже получше.
